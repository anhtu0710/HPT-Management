...
public class DoctorAddServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("patients", p.getAllPatient());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String dateString = request.getParameter("appointmentDate").replace("T", " ") + ":00";
        String reason_raw = request.getParameter("reason");
        Timestamp appDate = Timestamp.valueOf(dateString);
        ...
        response.sendRedirect("doctorAppointment");
    }
