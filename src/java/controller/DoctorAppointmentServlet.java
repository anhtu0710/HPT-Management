...
public class DoctorAppointmentServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        // Lấy doctorId từ session (giả sử đã lưu sau khi đăng nhập)
        ...
        List<Appointment> appointments = dao.getAppointmentsByDoctorId(doctorId);

        request.setAttribute("appointments", appointments);
        request.getRequestDispatcher("doctor_appointment.jsp").forward(request, response);
